...
function renderTask(task) {
  ...
  itemImportanceRating.classList.add('ImportanceRating');*/ // Setup delete button DOM elements
...
function settingsOnClick(event) {
    if (event.target === settings) toggleSettings();
}
...
//# sourceMappingURL=task_manager.762fc04c.js.map
